#!/usr/bin/env python3
"""Jack Farrell logo from styles3/logo2.png — gold foil style, transparent PNG."""
...
OUT = ROOT / "Images/styles3/logo-jack-farrell.png"
OUT_BLACK = ROOT / "Images/styles3/logo-jack-farrell-on-black.png"
...
- Text is ONLY two words: **Jack Farrell** — shorter than the source title
- Letterforms TALLER and OPEN — natural serif proportions, NOT horizontally stretched or flattened
- Generous letter spacing so every letter is clearly readable (J-a-c-k  F-a-r-r-e-l-l)
- Capitals J and F may have elegant swashes; do not crush or overlap neighboring letters
- Composition ~2:1 to 16:9 wide — balanced, not ultra-wide 4:1
- Comfortable breathing room; ornaments scale to the shorter phrase

CHANGE:
- Replace ALL title text with exactly: Jack Farrell
- No other words. No "The Night I Met Santa". No "God Bless".
- Do NOT bake a white matte.
"""
    print("=== Banana Pro edit -> Jack Farrell logo ===")
