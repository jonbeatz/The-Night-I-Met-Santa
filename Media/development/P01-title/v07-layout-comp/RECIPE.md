# RECIPE — P01-title / v07-layout-comp

| Field | Value |
|-------|--------|
| **name** | Winter Window — title page layout comp |
| **unit** | P01-title |
| **book page** | 1 · Title + Copyright · SINGLE |
| **page role** | single |
| **version** | v07-layout-comp |
| **date** | 2026-07-22 |
| **lane** | Pillow mock (Cormorant live-type preview) |
| **source art** | `Media/development/P01-title/v07/art.png` |
...
| **output** | `Media/development/P01-title/v07-layout-comp/layout.png` |
| **verdict** | pending |
